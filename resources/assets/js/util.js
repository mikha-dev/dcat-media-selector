...
function rightTableHtml() {
    ...
    html += '<li class="dropdown-item"><a class="media_selector_batch_delete"><i class="feather icon-trash"></i> Delete</a></li>';
    html += '<li class="dropdown-item"> <a class="media_selector_batch_mobile"><i class="fa fa-arrows-h"></i> Move </a></li>';
    html += '</ul>';
    html += '</div>';
    html += '<button type="button" class="btn btn-primary grid-refresh btn-mini btn-outline media_selector_toolbar_refresh" style="margin-right:3px"><i class="feather icon-refresh-cw"></i> Refresh</button>';
    html += '<button type="button" class="btn btn-primary grid-refresh btn-mini btn-outline media_selector_toolbar_filter" style="margin-right:3px"><i class="feather icon-filter"></i> Filter</button>';
    html += '<button type="button" class="btn btn-primary grid-refresh btn-mini btn-outline media_selector_toolbar_choose" style="margin-right:3px"><i class="fa fa-check"></i> Choose</button>';
    html += '<span style="position: relative;">';
    html += '<label class="btn btn-success grid-refresh btn-mini btn-outline"><i class="fa fa-upload"></i> Upload';
