...
class DcatMediaSelectorServiceProvider extends ServiceProvider
{
    ...
    public function init()
    {
        ...
        Admin::requireAssets(['@mikha-dev.dcat-media-selector', '@select2'], ['lang' => $lang]);
    }
...
//        $this->publishes([__DIR__ . '/../updates' => database_path('migrations')], 'dcat-media-selector-migrations');
        ...
        $this->publishes([
            __DIR__ . '/../resources/assets' => public_path('vendor/dcat-admin-extensions/mikha-dev/dcat-media-selector')
